            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
                ...
                <li class="menu-item has-child">
                  <a href="#" class="menu-link"><span class="menu-icon far fa-file"></span> <span class="menu-text">Outlet</span></a>
                  <ul class="menu">
                    <li class="menu-item">
                      <a href="#" onClick="loadRemotePage('outletinfo.php');" class="menu-link">Outlet Info</a>
                    </li>
                  </ul>  
                </li>
                ...
                <li class="menu-item has-child">
                  ...
                  <ul class="menu">
                    ...
                    <li class="menu-item">
                      <a href="#" class="menu-link" onClick="loadRemotePage('entryform.php');">Page Load</a>
                    </li>
